...
#ifndef TURTLEBOT3_MSGS__SRV__DQN__STRUCT_H_
#define TURTLEBOT3_MSGS__SRV__DQN__STRUCT_H_
...
{
  rosidl_generator_c__float__Sequence state;
  float reward;
  bool done;
...
#endif  // TURTLEBOT3_MSGS__SRV__DQN__STRUCT_H_
