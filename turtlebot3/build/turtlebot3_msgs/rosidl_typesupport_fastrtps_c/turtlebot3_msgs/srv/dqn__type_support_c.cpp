...
#include "turtlebot3_msgs/srv/dqn__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_generator_c/primitives_sequence.h"  // state
#include "rosidl_generator_c/primitives_sequence_functions.h"  // state
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: state
  {
    ...
    if (ros_message->state.data) {
      rosidl_generator_c__float__Sequence__fini(&ros_message->state);
    }
    if (!rosidl_generator_c__float__Sequence__init(&ros_message->state, size)) {
