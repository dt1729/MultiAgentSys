...
#include "turtlebot3_msgs/msg/version_info__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_generator_c/string.h"  // firmware, hardware, software
#include "rosidl_generator_c/string_functions.h"  // firmware, hardware, software
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: hardware
  {
    const rosidl_generator_c__String * str = &ros_message->hardware;
  ...
  // Field name: firmware
  {
    const rosidl_generator_c__String * str = &ros_message->firmware;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  // Field name: software
  {
    const rosidl_generator_c__String * str = &ros_message->software;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: hardware
  {
    ...
    if (!ros_message->hardware.data) {
      rosidl_generator_c__String__init(&ros_message->hardware);
    }
  ...
  // Field name: firmware
  {
    ...
    if (!ros_message->firmware.data) {
      rosidl_generator_c__String__init(&ros_message->firmware);
    }
    bool succeeded = rosidl_generator_c__String__assign(
  ...
  // Field name: software
  {
    ...
    if (!ros_message->software.data) {
      rosidl_generator_c__String__init(&ros_message->software);
    }
    bool succeeded = rosidl_generator_c__String__assign(
