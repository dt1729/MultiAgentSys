...
bool turtlebot3_msgs__msg__version_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "turtlebot3_msgs.msg._version_info.VersionInfo",
  ...
  {  // hardware
    ...
    rosidl_generator_c__String__assign(&ros_message->hardware, PyBytes_AS_STRING(encoded_field));
  ...
  {  // firmware
    ...
    rosidl_generator_c__String__assign(&ros_message->firmware, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // software
    ...
    rosidl_generator_c__String__assign(&ros_message->software, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
